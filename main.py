...
# BUY
            ...
            if params["Trade"] == "BUY":
                if params["TargetValue"] is not None  and params["FyersFutLtp"] >= params["TargetValue"] :
                    params["Trade"] =None
                    params["StoplossValue"] = None
                ...
                if  params["StoplossValue"] is not None  and params["FyersFutLtp"] <= params["StoplossValue"] :
                    params["Trade"] =None
                    params["StoplossValue"] = None
                    params["TargetValue"] = None
